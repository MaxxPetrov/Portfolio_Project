...
class GoogleChrome(unittest.TestCase):
    ...
    def test_icons_clickable(self):
        ...
        assert "https://twitter.com/nasa" in driver2.current_url
        ...
        assert "https://www.facebook.com/NASA/" in driver2.current_url
        ...
        assert "https://www.instagram.com/nasa/" in driver2.current_url
        ...
        assert "https://snapchat.com/add/nasa" in driver2.current_url
        ...
        assert "https://www.youtube.com/NASA" in driver2.current_url
        ...
        driver2.find_element(By.XPATH, HP.tumble).click()
        assert "https://nasa.tumblr.com/" in driver2.current_url
        ...
        assert "https://www.pinterest.com/nasa/" in driver2.current_url
        ...
        assert "https://giphy.com/nasa" in driver2.current_url
        ...
        assert "https://www.flickr.com/photos/nasahqphoto/" in driver2.current_url
        ...
        assert "https://www.twitch.tv/nasa/" in driver2.current_url
        ...
        assert "https://soundcloud.com/nasa" in driver2.current_url
        ...
        assert "https://www.reddit.com/user/nasa" in driver2.current_url
        ...
        assert "https://www.dailymotion.com/NASA" in driver2.current_url
    ...
    def test_upcoming_events_negative(self):
        ...
        # Verify user got Error Message:
        driver2.find_element(By.XPATH, "//label[contains(., '* Email')]")
    ...
    def test_search_field_negative(self):
        ...
        driver2.find_element(By.XPATH, '//div[contains(text(),"Sorry, no results found for")]')
...
class FireFox(unittest.TestCase):
    ...
    def test_icons_clickable(self):
        ...
        # Validate Snapchat linked icon leads to correct page:
        driver2.find_element(By.XPATH, HP.snapchat).click()
        assert "http://snapchat.com/add/nasa" in driver2.current_url
        print("Snapchat icon leads to Snapchat homepage")
    ...
    def test_upcoming_events(self):
        ...
        driver2.find_element(By.XPATH, '//button[@data-purpose="signup-submit-form"]')
